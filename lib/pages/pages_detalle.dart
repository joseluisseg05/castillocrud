...
class PageDetalle extends StatefulWidget {
  final bool editar;
  final Game game;

  PageDetalle(this.editar,{this.game}):assert(editar == true || game == null);

  @override
  _PageDetalleState createState() => _PageDetalleState();
}

class _PageDetalleState extends State<PageDetalle> {
                    ...
                    child:Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          image: _foto != null ? FileImage( _foto) : AssetImage('./images/select.png'),
                          //image: AssetImage(_foto?.path ?? "images/select.png"), 
                          fit: BoxFit.cover,
                        ),
                      ),
  ...
  _imgGame(){
   ...
   _selectFoto()async {
    ...
    imgString64 = Utility.base64String(_foto.readAsBytesSync());
    if(_foto != null){}
    setState(() {});
  }
